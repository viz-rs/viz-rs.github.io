...
pub fn Home(#[prop(into)] version: String) -> impl IntoView {
    ...
    view! {
        <section class="w-full hero text-center p-5 sm:py-19">
            ...
            <A href=move || format!("/{}/{}/guide/introduction", i18n.get_locale().as_str(), version) class="inline-block bg-neutral-900 text-neutral-100 dark:bg-neutral-100 dark:text-neutral-900 shadow py-2 px-4.5 border-rounded font-medium text-4 cursor-pointer">{t!(i18n, get_started)}</A>
        </section>
    }
}
