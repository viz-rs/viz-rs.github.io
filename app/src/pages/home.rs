        ...
        if #[cfg(feature = "en")] {
            view! { cx,
                <section class="w-full hero text-center p-5 sm:py-19">
                    ...
                    <A href={format!("/{}/guide/introduction", version())} class="inline-block bg-neutral-900 text-neutral-100 dark:bg-neutral-100 dark:text-neutral-900 shadow py-2 px-4.5 border-rounded font-medium text-4 cursor-pointer">"Get Started"</A>
                </section>
            }
        } else {
            view! { cx,
                <section class="w-full hero text-center p-5 sm:py-19">
                    ...
                    <a href={format!("/{}/guide/introduction", version())} class="inline-block bg-neutral-900 text-neutral-100 dark:bg-neutral-100 dark:text-neutral-900 shadow py-2 px-4.5 border-rounded font-medium text-4 cursor-pointer">"快速上手"</a>
                </section>
            }
        }
    }
